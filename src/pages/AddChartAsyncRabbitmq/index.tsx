...
import { addChartUsingPost, genChartAsyncByAiUsingPost, genChartByAiUsingPost, genChartMqByAiUsingPost, listChartByPageUsingPost } from '@/services/yupi/chartController';
...
const AddChartAsync: React.FC = () => {
    ...
    const onFinish = async (values: any) => {
        ...
        try {
            const res = await genChartMqByAiUsingPost(params, {}, values.file.file.originFileObj);
            console.log(res)
            if (!res?.data) {
