...
export async function genChartByAiUsingPost(
  ...
  return request<API.BaseResponseBIRespones_>('/api/chart/gen', {
    method: 'POST',
    params: {
      ...params,
    },
...
export async function genChartAsyncByAiUsingPost(
  ...
  return request<API.BaseResponseBIRespones_>('/api/chart/gen/async', {
    method: 'POST',
    params: {
      ...params,
    },
...
/** genChartMqByAi POST /api/chart/gen/async1 */
export async function genChartMqByAiUsingPost(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.genChartMqByAiUsingPOSTParams,
  body: {},
  file?: File,
  options?: { [key: string]: any },
) {
  ...
  return request<API.BaseResponseBIRespones_>('/api/chart/gen/async1', {
    method: 'POST',
    params: {
      ...params,
    },
